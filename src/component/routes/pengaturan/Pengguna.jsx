...
export default function EnhancedTable() {
    ...
    return (
        <div id="maincontent"  className="absolute  px-20 py-16 content flex flex-row gap-y-2 gap-x-6 left-[280px] top-[64px] p-4   ">
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <TableCell sx={{ maxWidth: 50 }} >
                                                    <Button onClick={(event)=>handleClickButton(event, row.name)} variant="contained">Ubah Role</Button>
                                                </TableCell>
                                            </TableRow>
                                        );
                                    })}
