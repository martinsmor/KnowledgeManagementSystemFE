              ...
              >
                ...
                <div>
                  <div className="flex flex-row gap-x-1 mt-2">
                    <div
                      className={
                        "flex transition hover:bg-rose-100 dark:hover:bg-gray-700 py-1.5 px-3 rounded-md flex-row justify-center items-center"
                      }
                    >
                      <span>
                        <svg
                    ...
                    <div
                      className={
                        "flex transition hover:bg-blue-100 dark:hover:bg-gray-700 py-1.5 px-3 rounded-md flex-row justify-center items-center"
                      }
                    >
                      <span>
                        <svg
                          ...
                          .map((tag, index) => (
                            <div
                              ...
                              className={
                                props.isGrid
                                  ? "hidden"
                                  : "flex transition hover:bg-green-200  dark:hover:bg-gray-700 py-1.5 px-3 rounded-md flex-row justify-center items-center"
                              }
                            >
